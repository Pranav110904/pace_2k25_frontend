...
const Footer = () => {
  return (
    <div>
      <footer className="bg-black hero3-container text-white font-[Genos] py-4">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="grid grid-cols-2 gap-4 text-center md:flex md:space-x-8">
              <a href="#" className="hover:text-gray-300">Home</a>
              <a href="#" className="hover:text-gray-300">Brochure</a>
              <a href="#" className="hover:text-gray-300">Rulebook</a>
              <a href="https://linktr.ee/pace2025" className="hover:text-gray-300">Contact Us</a>
            </div>
