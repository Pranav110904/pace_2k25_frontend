  ...
  return (
    <div className="relative bg-black text-white h-screen flex items-center justify-center">
      ...
      <img
        src={cricket}
        alt="Cricketer"
        className="absolute left-70 bottom-25 w-1/6 z-10"
      />
      <img
        src={football}
        alt="Footballer"
        className="absolute right-70 bottom-27 w-1/6 z-10"
      />


      <div className="relative text-center z-20">
      <h1
          className="text-[200px] font-bold font-[Genos] tracking-wide uppercase"
          style={{
